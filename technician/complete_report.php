...
// instantiate class
$get = new GetCompleteRecords($conn);
...
<section>
  ...
  <div class="row">
   ...
   <div class="col-6 mb-3">
     ...
     <input type="hidden" required="" name="update_techUserId" value="<?= $user_id ?>"> 
     <input type="hidden" required="" name="update_tech" value="<?= $full_name ?>">
   </div>

   <div class="col-6 mb-3 text-end">
      <input type="submit" name="btnUpdateRecords" class="mt-3 btn btn-outline-success btn-sm" value="Update">  <a href="index" class="btn btn-outline-danger btn-sm mt-3 text-decoration-none">Back</a>
   </div>
     ...
     <div class="row">
       <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
         ...
         <select class="form-control" required="" name="update_remarks">
   ...
   <div class="col-md-6 mb-3">
     ...
     <div class="row">
       <div class="col-md-12 mb-3">
        ...
        <div class="input-group">
         <span class="input-group-text"><i class="fa-brands fa-evernote"></i></span>
         <select class="form-control" required="" name="update_statusReport">
