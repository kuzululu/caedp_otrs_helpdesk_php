 ...
 <div class="container-fluid">
  <div class="row">
    <div class="col-md-12 col-lg-12">
     <h2 class="fw-bolder fst-italic text-uppercase animate__animated animate__fadeIn animate__infinite infinite">Incident Records</h2>
    </div>
  </div>  
 </div> 
</section>
...
<section class="mt-3">
 <div class="container-fluid">
  ...
  <div class="col-md-4 d-md-flex">
    ...
    <input type="search" id="filterIncident" class="form-control resetSearch" placeholder="Filter by Remarks, Unit Status, Services, Status Report, End User"> <button class="resetBtn btn btn-secondary btn-sm" type="button">Reset</button>
  </div> 
</div> 
 </div> 
</section>
...
<div class="row">   	
  ...
  <div class="table-responsive" id="filterIncidentTable">
