...
<!-- <div class="col-md-4 col-lg-4"></div> -->
 <div class="col-md-6 col-lg-6 mb-3">
 	 <div class="mt-md-5 pt-md-5">
 	  <center><img src="img/logoCA.png" class="animate__animated animate__zoomIn animate__slow img-fluid d-md-block d-lg-block d-none
      " height="320" width="320"></center>
       <center><img src="img/logoCA.png" class="animate__animated animate__zoomIn animate__slow img-fluid d-md-none d-lg-none d-block
