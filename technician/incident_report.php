...
<section>
  ...
  <div class="row">
   ...
   <div class="col-6 mb-3 text-end">
      <input type="submit" name="btnUpdateIncidentReport" class="mt-3 btn btn-outline-success btn-sm" value="Update">  <a href="incident_records" class="btn btn-outline-danger btn-sm mt-3 text-decoration-none">Back</a>
   </div>
