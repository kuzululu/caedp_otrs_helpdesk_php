 ...
 <div class="container-fluid">
  <div class="row">
    <div class="col-md-12 col-lg-12">
     <h2 class="fw-bolder fst-italic text-uppercase animate__animated animate__fadeIn animate__infinite infinite">View Records</h2>
    </div>
  </div>  
 </div> 
</section>
...
<section class="mt-3">
 <div class="container-fluid">
  ...
  <div class="col-md-4 d-md-flex">
    ...
    <input type="search" id="filterRecords" class="form-control resetSearch"> <button class="resetBtn btn btn-secondary btn-sm" type="button">Reset</button>
  </div> 
</div> 
 </div> 
</section>
...
<div class="row">   	
  ...
  <div class="table-responsive" id="filterRecordsTable">
...
?>  	 
  <tr class="text-center align-middle">
    ...
    <td class="align-top"><?= htmlspecialchars($row["technician"]) ?></td>
  	<td>
  		<a href="details?id=<?= htmlspecialchars(urlencode(base64_encode($row['id']))) ?>" class="btn btn-outline-secondary btn-sm">View</a>
  	</td>
  </tr>
<?php
$ctr++;
